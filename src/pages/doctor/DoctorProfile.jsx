...
export default function DoctorProfile() {
  ...
  const [profile, setProfile] = useState({
    ...
    email: user?.email || 'dr.anita@hospital.com',
      ...
      <div className="card">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-700 font-medium text-sm border-l-4 border-l-blue-500 pl-2">{profile.specialty}</p>
          ...
          <div className="flex gap-2">
            <div className="flex items-center gap-1 bg-amber-50 px-3 py-1.5 rounded-xl">
              ...
              <span className="text-amber-500 text-xs">(85 reviews)</span>
            </div>
        ...
        {editing && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
            ...
            <div><label className="label">Specialty</label><input value={profile.specialty} onChange={e => setProfile(p => ({ ...p, specialty: e.target.value }))} className="input-field" /></div>
